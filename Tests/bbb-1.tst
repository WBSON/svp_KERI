<scriptConfig name="bbb-1" script="battsim_comm">
  <params>
    ...
    <param name="battsim.Chroma.OCV" type="string">100,80,30,10</param>
    <param name="battsim.Chroma.SOC" type="string">50,40,15,5</param>
