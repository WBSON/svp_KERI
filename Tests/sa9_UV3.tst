<scriptConfig name="sa9_UV3" script="SA9_volt_ride_through">
  <params>
    <param name="eut.v_msa" type="float">0.0</param>
    <param name="eut.t_msa" type="float">0.2</param>
    <param name="vrt.t_hold" type="float">1.0</param>
    <param name="vrt.n_r" type="int">2</param>
    ...
    <param name="vrt.v_test" type="float">49.0</param>
    ...
    <param name="das_das_rms.wt3000.baud_rate" type="int">19200</param>
    <param name="das_das_wf.wt3000.baud_rate" type="int">19200</param>
    ...
    <param name="vrt.phase_1" type="string">Disabled</param>
    ...
    <param name="vrt.mode" type="string">Momentary Cessation</param>
